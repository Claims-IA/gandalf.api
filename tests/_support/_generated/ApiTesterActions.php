<?php  //[STAMP] 2915de459e469d26884ef0bf16570c1a
...
trait ApiTesterActions
{
     ...
     * @see \Helper\Api::grabResponseToFile()
     */
    public function grabResponseToFile($path) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('grabResponseToFile', func_get_args()));
    }
     ...
     * @see \Helper\Api::sendFileMultipart()
     */
    public function sendFileMultipart($url, $path, $params = null, $field = null) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('sendFileMultipart', func_get_args()));
    }
